...
constructor(){
  ...
  this.bodybottom= Bodies.rectangle(800,470,200,20,options);
  this.width1=200;
  this.height1=20;
  
  this.bodyleft= Bodies.rectangle(750,520,20,100,options);
  this.width2=20;
  this.height2=100;
      
  this.bodyright= Bodies.rectangle(850,550,20,100,options);
  this.width3=20;
  this.height3=100;
